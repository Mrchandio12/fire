...
// --- CONFIGURATION ---
const CREDENTIALS = {
    username: "Samiullahjappa",
    password: "Dadujo"
};

const BASE_URL = "http://54.39.104.241/ints";
...
function extractKey(html) {
    let match = html.match(/sesskey=([^&"'\s<>]+)/);
...
async function _doLogin() {
    ...
    for (let attempt = 1; attempt <= MAX_RETRIES; attempt++) {
        ...
        try {
            ...
            if (r3.data.includes('id="loginform"') || r3.data.includes("name='capt'") || r3.data.includes('name="capt"')) {
    ...
    if (type === 'numbers') {
        ...
        try {
            const raw = await fetchWithRelogin(
                () => {
                    const ts = Date.now();
                    return `${BASE_URL}/agent/res/data_smsnumbers.php?frange=&fclient=&sEcho=2&iColumns=8&sColumns=%2C%2C%2C%2C%2C%2C%2C&iDisplayStart=0&iDisplayLength=-1&mDataProp_0=0&sSearch_0=&bRegex_0=false&bSearchable_0=true&bSortable_0=false&mDataProp_1=1&sSearch_1=&bRegex_1=false&bSearchable_1=true&bSortable_1=true&mDataProp_2=2&sSearch_2=&bRegex_2=false&bSearchable_2=true&bSortable_2=true&mDataProp_3=3&sSearch_3=&bRegex_3=false&bSearchable_3=true&bSortable_3=true&mDataProp_4=4&sSearch_4=&bRegex_4=false&bSearchable_4=true&bSortable_4=true&mDataProp_5=5&sSearch_5=&bRegex_5=false&bSearchable_5=true&bSortable_5=true&mDataProp_6=6&sSearch_6=&bRegex_6=false&bSearchable_6=true&bSortable_6=true&mDataProp_7=7&sSearch_7=&bRegex_7=false&bSearchable_7=true&bSortable_7=false&sSearch=&bRegex=false&iSortCol_0=0&sSortDir_0=asc&iSortingCols=1&_=${ts}`;
                },
                referer
            );
...
function fixSMS(data) {
    if (!data.aaData) return data;
    data.aaData = data.aaData.map(row => {
        const message = (typeof row[5] === 'string' ? row[5] : "").replace(/kamibroken/gi, "").trim();
